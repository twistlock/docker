...
// AuthorizationPlugin allows third party plugins to authorize requests and responses
...
func NewPlugins(names []string) []AuthorizationPlugin {
	plugins := make([]AuthorizationPlugin, len(names))
...
func newAuthorizationPlugin(name string) AuthorizationPlugin {
